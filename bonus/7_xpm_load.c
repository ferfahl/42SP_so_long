...
/*   Updated: 2022/11/05 19:24:06 by feralves         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_img(t_vars *vars)
{
	...
	load_xpm(vars, &(vars->sprite.villain.right2), SPRITE_V2);
	load_xpm(vars, &(vars->sprite.villain.left1), SPRITE_V3);
	load_xpm(vars, &(vars->sprite.wall.op1), SPRITE_W1);
	load_xpm(vars, &(vars->sprite.wall.op2), SPRITE_W2);
	...
	load_xpm(vars, &(vars->sprite.floor.op1), SPRITE_F2);
